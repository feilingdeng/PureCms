...
using PureCms.Plugin.Pay.Alipay;
...
namespace Com.Alipay
{
    ...
    public class Config
    {
        ...
        static Config()
        {
            ...
            partner = PluginCore.GetSettings().Partner;

            //收款支付宝账号，以2088开头由16位纯数字组成的字符串
            seller_id = PluginCore.GetSettings().Seller;

            //商户的私钥
            private_key = PluginCore.GetSettings().PrivateKey;
