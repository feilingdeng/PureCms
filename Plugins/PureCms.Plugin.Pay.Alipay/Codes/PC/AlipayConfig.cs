...
namespace PureCms.Plugin.Pay.Alipay
{
    ...
    public class AlipayConfig
    {
        ...
        static AlipayConfig()
        {
            _seller = PluginCore.GetSettings().Seller;
            _partner = PluginCore.GetSettings().Partner;
            _key = PluginCore.GetSettings().Key;
            ...
            _privatekey = PluginCore.GetSettings().PrivateKey;
