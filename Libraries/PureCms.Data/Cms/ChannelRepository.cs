...
namespace PureCms.Data.Cms
{
    public class ChannelRepository : IChannelRepository
    {
        ...
        /// <returns></returns>
        public bool Update(UpdateContext<ChannelInfo> context)
        {
        ...
        /// <param name="q">上下文</param>
        /// <returns></returns>
        public PagedList<ChannelInfo> QueryPaged(QueryDescriptor<ChannelInfo> q)
        {
        ...
        /// <param name="q"></param>
        /// <returns></returns>
        public List<ChannelInfo> Query(QueryDescriptor<ChannelInfo> q)
        {
