...
{
    public class UploadSetting : ISetting
    {
        public const string CACHE_KEY = "$UploadSetting$";
        #region 上传设置
        ...
        private string _articlethumbsize = "";//文章缩略图大小
        ...
        /// 文章缩略图大小
        /// </summary>
        public string ArticleThumbSize
        {
            get { return _articlethumbsize; }
            set { _articlethumbsize = value; }
        }
